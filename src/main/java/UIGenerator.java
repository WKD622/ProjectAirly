...
public class UIGenerator {
    ...
    public String showPresent(JsonModel jsonModel){
        int caqi = jsonModel.getCurrentMeasurements().getAirQualityIndex();
        int pm10 = jsonModel.getCurrentMeasurements().getPm10();
        int pm25 = jsonModel.getCurrentMeasurements().getPm25();
        int tmp = jsonModel.getCurrentMeasurements().getTemperature();
        int preassure = jsonModel.getCurrentMeasurements().getPressure();
        int windSpeed = jsonModel.getCurrentMeasurements().getWindSpeed();
        int windDirection = jsonModel.getCurrentMeasurements().getWindSpeed();
    ...
    private String createEndOfBorder(int value){
        if (value > 9 || (value < 0 && value > -9)) return " ║\n";
